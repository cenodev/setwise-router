...
const files = [
  ...
  "scripts/lib/ethereum-differential.mjs",
  ...
  "test/bsc-testnet-deployment-record.test.js",
  "test/bsc-testnet-rollout.test.js",
  ...
  "test/ethereum-differential.test.js",
  "config/schema.mjs",
  "config/registry.mjs",
